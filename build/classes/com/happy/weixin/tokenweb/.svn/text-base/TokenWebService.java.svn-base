package com.happy.weixin.tokenweb;
...
public class TokenWebService {
	 ...
	 * @return
	 */
	public static TokenWeb getNewTokenWebObject(String appid,String appsecret,String code){
		String str = getNewTokenWeb(appid, appsecret, code);
